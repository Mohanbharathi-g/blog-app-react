...
import userProfile from '../assets/png-clipart-computer-icons-avatar-icon-design-avatar-heroes-computer-wallpaper-thumbnail.png';
                      ...
                      <Link to={'/userinfo'}>
                        <div className='profile-logo'>
                          <img
                            ...
                            alt='logo'
                            className='profile-img-header profile-image'
                          />
                        </div>
                      </Link>
                      <Link
